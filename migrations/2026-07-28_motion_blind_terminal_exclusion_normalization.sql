-- 기존 blind slot보다 늦게 terminal exclusion이 기록된 영상을 큐·workspace에서 숨긴다.
--
-- slot/consensus/submission/삭제 감사 row는 보존하고 읽기 경로만 forward 교체한다.
