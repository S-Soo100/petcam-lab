...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--final-multi-sources", type=int, default=15)
    parser.add_argument("--final-hard-negative-sources", type=int, default=15)
    parser.add_argument("--final-hard-positive-sources", type=int, default=15)
    parser.add_argument("--final-coverage-sources", type=int, default=35)
    parser.add_argument("--final-max-per-night", type=int, default=5)
    parser.add_argument("--review-frames-per-source", type=int, default=4)
