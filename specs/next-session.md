...
> **🟢 2026-07-27 AI 연구 운영 계약 연결 — `AI_OPERATING_CONTRACT_R1_GATE`:** R1 plan·runtime 작업 전에 [`AI 연구 운영 계약`](../docs/research/AI-OPERATING-CONTRACT.md)의 run manifest를 작성하고 [`validator`](../scripts/verify_research_run_manifest.py)로 검증해야 한다. 이 contract는 R1의 선행 gate라서 통과 전에는 runtime 구현·장기 job을 시작하지 않는다.
