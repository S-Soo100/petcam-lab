...
> **🟢 2026-07-31 Data Engine formal Blind30 — `BLIND30_PREFROZEN_READY`:** [`TEST-SHEET`](../experiments/rba-data-engine-blind30/TEST-SHEET.md)의 threshold·selection·`motion-blind-v1` 계약을 바꾸지 않고 B그룹 qualified non-owner 2인과 실 T0 `2026-07-31T03:44:27.183403+09:00` metadata-only exact 30을 동결했다. eligible `15,678`, camera 3, camera-night 30, selected 5-minute duplicate 0이며 manifest mode `0600`, SHA-256 `e335c82a642f2cfe63e0c9d42d8f7fb92c9918e5a76e4333acf36722c7426377`다. production RPC를 정확히 1회 호출해 open cohort 1, slots 60(30/30), awaiting consensus 30, submission 0을 검증했고 live slots/submissions/consensus count·hash는 직전과 정확히 불변이다. PASS의 인증 범위는 natural production distribution의 2인 일치도·abstain·owner adjudication 부담·운영무결성뿐이며 희소행동, taxonomy, train/validation GT, 모델/VLM/Gate/router/P0, chance-corrected agreement는 인증하지 않는다. 다음은 두 reviewer의 blind 30/30 human 제출이며 둘 다 완료하기 전 owner adjudication·Task 8을 시작하지 않는다. backlog 300 human-first Gate 감사는 별도 pending이다.
