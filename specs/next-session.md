...
> **최종 갱신: 2026-07-17 — S1 throughput benchmark `S1_HOLD_RUNTIME_BUDGET`.** MPS 20분 budget 소진. CROI cap=1,417/h·ratio=17.71x·안전 위반 없음. warm·CPU·A6 미완(A6=FileNotFoundError). 재실행 필요. feature `feat/python-evidence-s1-benchmark` @ `cf20dcef` 결과 push 완료.
