...
> **🟡 2026-07-30 Data Engine 다음 착수점 — formal blind 30 사전동결:** tutorial-v1 production onboarding은 non-owner 2명의 5/5 완료와 이후 live 제출 100건/68건으로 검증됐다. 신규 라벨러에게 tutorial+first-5를 반복시키는 계획은 superseded다. double-blind engine도 paired 53건(07-27 45, 07-29 8), 자동 합의 14, paired owner adjudication 39의 운영 증거가 있다. 다음은 기존 53쌍을 EDA로만 남기고 exact sample/reviewer/comparator/segment tolerance/uncertain·abstain/owner adjudication/pass-fail을 제출 전에 동결하는 blind 30 TEST-SHEET다. `owner-single-adopt-v1` 47건은 단일 reviewer provenance라 agreement·blind30·학습/평가에서 제외한다. backlog 300 human-first Gate 감사는 별도 pending이다.
