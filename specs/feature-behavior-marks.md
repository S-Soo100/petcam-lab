...
**상태:** 🚧 1단계 배포 완료(2026-09-11, DB·fly v8·Vercel) — 2단계 진행 예정 (`docs/superpowers/plans/2026-09-11-behavior-marks.md`). **v2 슬롯안은 ChatGPT 검토(2026-09-11)로 폐기**: 총량 증가·미검증 지표 선정 반영·사람 X 의미 미정. §0b 의 슬롯(움직임2·격함2·클로즈업1)은 **3단계**(블라인드 평가 통과 뒤, 하루 예산 15 안 다양성 배분)로 이월. 1단계 = 표시 4종 + 예산 15 + 의심 서명 검수 + 회귀 세트, 선정 논리 불변.
