...
| 🚧 | [feature-rba-data-engine-v1.md](feature-rba-data-engine-v1.md) | **방향 확정 / 구현 전.** 카메라·개체·사육장 확대 → 클래스별 다양한 운영 영상+paired negative → 사람 blind GT → 라벨링 웹 v2 → Gate v3 shadow를 production VLM/router 재검증보다 먼저 수행 |
