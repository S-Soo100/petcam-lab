...
| 🚧 | [feature-rba-data-engine-v1.md](feature-rba-data-engine-v1.md) | **방향 확정 / 라벨링 웹 v2 코드 완료·운영 적용 대기.** blind GT→exact VLM 검수와 썸네일 복구 구현·334+15 tests/tsc 통과. Supabase migration·Vercel 배포는 운영 프로젝트 권한 확보 후 수행. 이후 카메라·개체·사육장 확대 → Gate v3 shadow 순서 |
