...
| 🚧 | [feature-rba-data-engine-v1.md](feature-rba-data-engine-v1.md) | **tutorial onboarding production evidence verified / double-blind operational.** formal blind 30 계약은 동결했지만 완료 non-owner pair가 서로 다른 active group이고 generic canary가 20개 상한이라 exact-30 예약 구현·같은 group 두 번째 실제 5/5가 대기다. 기존 paired 53은 EDA, single-adopt 47은 agreement에서 제외 |
