...
| 🚧 | [feature-rba-data-engine-v1.md](feature-rba-data-engine-v1.md) | **tutorial onboarding verified / double-blind operational / formal30 reservation approved.** production B그룹 qualified non-owner 2인과 metadata dry-run exact 30을 확인했고 owner가 Task 7을 승인했다. PASS는 natural distribution의 measurement-system 일치도·abstain·adjudication 부담·운영무결성만 인증하며 희소행동/taxonomy/GT/model 성능은 인증하지 않는다. 기존 paired 53은 EDA, single-adopt 47은 agreement에서 제외 |
