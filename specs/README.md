...
| 🚧 | [feature-rba-data-engine-v1.md](feature-rba-data-engine-v1.md) | **Canonical GT Production 통일 완료 / GME_SHADOW_DIRECT_CUTOVER_APPROVED.** 사람 GT canonical 원장은 Owner·보관함·대시보드·export까지 배포했다. local VLM/router·자동 사건 묶기·Claude CLI 영상 판독은 종료하고 [`Gecko Motion Engine`](../docs/superpowers/specs/2026-08-03-gecko-motion-engine-v1-design.md)은 Gate 기반 검출·전 프레임 추적·실제 게코 움직인 시간을 맡는다. Dataset v2·GME 후속 완료 조건은 진행 중이다. |
