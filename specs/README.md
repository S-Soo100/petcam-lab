...
| 🚧 | [experiment-claude-montage-v2.md](experiment-claude-montage-v2.md) | **신규 2026-06-12 — 방향 피벗 계획서.** Gemini API 퇴역(사용자 결정) → Claude 구독 트랙으로 연구 전환. 입력표현 연구: 몽타주 v2(고해상 격자 — "v1 패인=셀 72px" 가설) M0~M3 + claude-video 레시피(cv-frames) V1. 게이트: frames-10 81.7% 대비 −3%p AND 토큰 ≥2× 절감. Gemini 클로징 145건 기록 `experiments/gemini-final-partial/` |
