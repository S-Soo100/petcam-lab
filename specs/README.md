...
| 🚧 | [experiment-event-segment-vlm.md](experiment-event-segment-vlm.md) | **신규 2026-05-16** — 1~4분 영상을 motion/ROI 기반 5~15초 event로 쪼개고 event별 VLM 분석 후 clip-level timeline으로 병합하는 사이드 플랜. production 변경 없이 baseline(60초 top-1) 대비 P0 recall, false highlight, HITL review 효율, 비용/latency 비교 |
