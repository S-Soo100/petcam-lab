...
| 🟡 | [router-cost-v2/TEST-SHEET.md](../experiments/router-cost-v2/TEST-SHEET.md) | **실행 전 / 계약 동결 대기.** 저비용 API baseline과 router policy를 먼저 동결하고 승인 이후 future camera-night만 평가. 14박·300 clips, P0 30 pilot / 150 adoption, total eventual KRW·P0 recall·review burden·delay 동시 gate |
