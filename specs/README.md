...
| 🚧 | [feature-rba-data-engine-v1.md](feature-rba-data-engine-v1.md) | **라벨링 웹 v2·공통 5개 tutorial-v1 production 완료 / 실제 라벨러 1명 pilot 대기.** 다음은 5/5+첫 본작업 5개에서 시간·uncertain·재검수 비율 측정 → 공통 blind 30 계약 동결 → 카메라·개체·사육장 확대 순서 |
