...
| 🚧 | [experiment-weak-model-levers.md](experiment-weak-model-levers.md) | **신규 2026-06-10** — Fable 5 격차(81.7→85.1%)를 약한 모델에서 5레버(입력표현·표적룰·캐스케이드 시뮬·다모델합의·증거 PoC)로 회수 실측 → Gemini Flash↔Pro 설계 사전검증. P1 baseline(Opus 4.8 ± Sonnet 4.6) → P2~P6 레버 → P7 종합. 설계 확정 대기 (baseline 구성·착수 시점) |
