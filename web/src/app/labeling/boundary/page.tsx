...
import type { BoundaryDecision, BoundaryWorkspace } from '@/lib/rbaBoundaryServer';
  ...
  return (
    <div className="space-y-4 py-6">
      <div className="flex items-end justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-zinc-950">영상 이어짐 확인</h1>
          <p className="mt-1 text-sm text-zinc-600">완료 {workspace.completed} / {workspace.total}</p>
        </div>
        {workspace.reviewer_role === 'owner' && (
