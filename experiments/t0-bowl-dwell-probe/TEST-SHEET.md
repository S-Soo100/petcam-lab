...
**작성:** 2026-07-20 · **승인:** 2026-07-20 (owner) · **상태:** ⛔ **SUPERSEDED (실행 전 폐기, 2026-07-20)**

> **폐기 사유:** owner 실측 확인 — 그릇 위치가 급여마다 바뀜 + detector는 gecko 단일 클래스(그릇 검출 없음) → 고정 그릇 셀 지정 전제 자체가 무효. 인퍼런스/판정 실행 전 폐기라 결과 오염 없음. 후속: [`t0-care-pattern-probe`](../t0-care-pattern-probe/) — 위치 무관 패턴 점수(체류 집중 × 반복성)로 교체, 계획서 [`2026-07-20-t0-care-pattern-probe.md`](../../docs/superpowers/plans/2026-07-20-t0-care-pattern-probe.md) (v2 시험지 owner 승인 동결 완료).
