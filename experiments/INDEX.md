...
| 2026-07-21 | **T1 highlight-selection probe** (DB-only 합성점수 top20 vs random20, 사람 blind, LLM 0회) | (실행 중 — 시트 🔒 동결, S20+R20 blind 시트 생성, owner 판정 대기) | — | [t1-highlight-selection/TEST-SHEET.md](t1-highlight-selection/TEST-SHEET.md) |
