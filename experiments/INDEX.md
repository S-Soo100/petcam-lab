...
| 2026-07-09 | **local-router-v2** metadata-first deterministic router | `hold-policy-too-conservative` | L0 v2 cloud_now 197/197=100.0%, cloud_later 0건이라 v1보다 더 보수적으로 붕괴. P0→activity_only 0.0%, L1 qwen은 `skipped_l0_not_improved`. | [local-router-v2/REPORT.md](local-router-v2/REPORT.md) |
