...
| 2026-07-21 | **T1 highlight-selection probe** (DB-only 합성점수 top20 vs random20, 사람 blind, LLM 0회) | (대기 — TEST-SHEET 승인 STOP) | — | [t1-highlight-selection/TEST-SHEET.md](t1-highlight-selection/TEST-SHEET.md) |
