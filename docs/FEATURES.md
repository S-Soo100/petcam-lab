...
**v2 방향:** 이 웹을 단순 검수 화면에서 사람 blind GT 생산 도구로 발전시킨다. prediction 최초 숨김, event/uncertain/multi-action, Gate bbox 교정, camera-night provenance와 split 경고가 핵심이다. 상세 [RBA Data Engine v1](../specs/feature-rba-data-engine-v1.md).
