...
**가입·승인·간편 날짜(2026-07-13, 구현 완료·배포 전):** 팀원이 웹에서 직접 가입 신청하고
...
- 검증: Python 334, Web 60 tests, TypeScript 통과. 로컬 `next build`는 프로젝트 guard로
  실행하지 못했고 Vercel preview도 로컬 upload-root 설정 문제로 Ready 생성 전 중단했다.
