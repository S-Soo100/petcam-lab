...
- 세 프로세스가 공유: `.env` 또는 fly secrets (Supabase / R2 / Fernet / DEV_USER_ID / GEMINI_API_KEY), DB 스키마, R2 버킷, contract = `clip_recorder` payload, prompts SOT (`web/prompts/backups/`).
