...
> 상태: 설계 승인(2026-07-13). 구현·기준 GT 보정·seed·activation·배포는 아직 하지 않는다.
>
> 연관 문서:
...
| 3 | wheel+복수 행동 | wheel interaction, enrichment wheel, interaction type 1개 이상, target != tool, 세부 행동 2개 이상 |
