...
- [x] **Step 1: decision guard 실패 테스트 작성**
...
- [x] **Step 1: migration 정적 실패 테스트 작성**
...
- [x] **Step 2: runtime probe에 보존·matrix·정정 단언 추가**
...
- [x] **Step 2: production preflight read-only**
