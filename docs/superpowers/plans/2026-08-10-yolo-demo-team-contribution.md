...
- [ ] **Step 1: DTO validator와 frame 선택 RED 작성**
...
- [ ] **Step 3: 최소 DTO와 validator GREEN 구현**
...
- [ ] **Step 4: upload/provider/limiter RED 작성**
...
- [ ] **Step 5: provider boundary GREEN 구현**
...
- [ ] **Step 1: route integration RED 작성**
...
- [ ] **Step 3: route GREEN 구현**

실제 route는 module-level in-memory limiter와 environment provider resolver를 주입한다.
`NODE_ENV=production`에서 `YOLO_ALLOW_FAKE_DEMO=true`가 아니면 fake provider를 선택하지 않는다.

- [ ] **Step 4: overlay/UI RED 작성**
...
- [ ] **Step 6: focused GREEN과 build smoke**
...
- [ ] **Step 1: migration behavior RED 작성**
...
- [ ] **Step 3: schema와 append-only trigger GREEN 구현**
...
- [ ] **Step 4: RPC ordering/authorization GREEN 구현**
...
- [ ] **Step 1: allowlist mapper RED 작성**
...
- [ ] **Step 6: focused GREEN과 accessibility smoke**
