...
- [ ] **Step 1: 시간 표시와 기본 markup RED 테스트 작성**
...
- [ ] **Step 1: raw video 단일소유 RED 감사 테스트 작성**
...
- [ ] **Step 3: 모든 raw video를 ReviewVideo로 교체**
